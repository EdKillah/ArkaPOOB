	...
	public void abrir(){
		...
		if(val == JFileChooser.APPROVE_OPTION){
			...
			try{
				...
				PantallaDeJuego pj = new PantallaDeJuego(juego.getJugadores(),juego.getColores()[0],juego.getColores()[1],juego.getColores()[2],juego.getColores()[3],juego.getColores()[4]);
				pj.crearJuego(juego);
				pj.setVisible(true);	
